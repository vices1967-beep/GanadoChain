    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet_address', models.CharField(max_length=42, unique=True, validators=[core.models.validate_ethereum_address], verbose_name='Dirección Wallet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('HEALTH_ALERT', 'Alerta de Salud'), ('BLOCKCHAIN_TX', 'Transacción Blockchain'), ('IOT_ALERT', 'Alerta IoT'), ('BATCH_UPDATE', 'Actualización de Lote'), ('ROLE_CHANGE', 'Cambio de Rol'), ('REPUTATION_UPDATE', 'Actualización de Reputación')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reputation_type', models.CharField(choices=[('PRODUCER', 'Productor'), ('VET', 'Veterinario'), ('FRIGORIFICO', 'Frigorífico'), ('AUDITOR', 'Auditor')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blockchain_tx_hash', models.CharField(blank=True, max_length=66, validators=[core.models.validate_transaction_hash], verbose_name='Hash de Transacción')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role_type', models.CharField(choices=[], max_length=20)),
                ('scope_type', models.CharField(choices=[('GLOBAL', 'Global'), ('BATCH', 'Por Lote'), ('ANIMAL', 'Por Animal'), ('LOCATION', 'Por Ubicación')], default='GLOBAL', max_length=10)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='detailed_roles', to=settings.AUTH_USER_MODEL)),
            ],
            options={
