    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_address', models.CharField(blank=True, max_length=42)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('implementation_address', models.CharField(blank=True, max_length=42)),
                ('proxy_address', models.CharField(blank=True, max_length=42)),
                ('is_upgradeable', models.BooleanField(default=False)),
                ('admin_address', models.CharField(blank=True, max_length=42)),
            ],
            options={
